...
export default function Weiqi() {
  return (
    ...
    <Row>
      ...
      <Col span={12}>
        <Image src="/majors/围棋奖状.jpg" alt="" />
      </Col>
    </Row>
    <Row>
      <Col span={12}>
        <Image src="/majors/围棋奖状1.jpg" alt="" />
      </Col>
      <Col span={12}>
        <Typography.Paragraph>
          一年两度的棋力测评是围棋专业的重头戏，益智艺术培训中心会根据学员的棋力水平进行分组比赛。经过激烈角逐，综合学员的赛场成绩和日常表现，围棋专业的教师们会对学员的棋力进行专业评价，并对积极参与棋力测评的学员和表现优异的学员们进行嘉奖，激发学员的对弈热情。
        </Typography.Paragraph>
      </Col>
    </Row>
    <Row>
      ...
      <Col span={12}>
        <Image src="/majors/围棋电教室.png" alt="" />
      </Col>
    </Row>
  </>
  )
